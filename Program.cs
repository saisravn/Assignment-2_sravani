            ...
            try
            {
                ...
                if (nums.Length == 1)
                {
                    ...
                    else
                    {
                        ...
                        list1.Add(new List<int> { lower + 1, nums[0] - 1 });

                        list1.Add(new List<int> { nums[0] + 1, upper - 1 });
                ...
                else
                {
                    ...
                    for (int i = 0; i < nums.Length; i++)
                    {
                        ...
                        {
                            list1.Add(new List<int> { temp + 1, nums[i] - 1 });
                    ...
                    {
                        list1.Add(new List<int> { nums[nums.Length - 1], upper });
                    }
